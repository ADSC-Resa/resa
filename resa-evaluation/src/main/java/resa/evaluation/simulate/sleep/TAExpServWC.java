...
/**
 * This topology demonstrates how to use Resa modules
 */
public class TAExpServWC {
    ...
    public static void main(String[] args) throws Exception {
        ...
        conf.setMaxSpoutPending(ConfigUtil.getInt(conf, "chain-MaxSpoutPending", 1));
        ...
        StormSubmitter.submitTopology("chain-top-1", resaConfig, builder.createTopology());
    }
}
