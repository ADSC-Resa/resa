 ...
 * *
 */
public class StormVideoLogoDetectorBeta {
     ...
     */
    public StormVideoLogoDetectorBeta(Parameters params, String fileName, int logoIndex, int maxTemplateSize) {
...
//            }
     ...
     * @see resa.evaluation.topology.tomVLD.LogoTemplate#toString()
     */
