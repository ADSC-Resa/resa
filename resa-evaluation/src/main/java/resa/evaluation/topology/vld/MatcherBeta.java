...
public class MatcherBeta extends BaseRichBolt {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(MatcherBeta.class);
...
//        loadIndex(context.getThisTaskIndex(), context.getComponentTasks(context.getThisComponentId()).size());
    ...
    public void execute(Tuple input) {
        ...
        collector.emit(STREAM_MATCH_IMAGES, input, new Values(frameId, matches, feaDescCnt));
        collector.ack(input);
    }
