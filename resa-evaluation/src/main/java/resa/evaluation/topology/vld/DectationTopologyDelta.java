 ...
 */
public class DectationTopologyDelta implements Constant {
    ...
    public static void main(String[] args) throws Exception {
        ...
        builder.setBolt("patch-gen", new PatchGenDelta(), getInt(conf, "vd.patch-gen.parallelism", 1))
                .shuffleGrouping("image-input", STREAM_IMG_OUTPUT)
                .setNumTasks(getInt(conf, "vd.patch-gen.tasks", 1));
        builder.setBolt("feat-ext", new FeatureExtracterDelta(), getInt(conf, "vd.feat-ext.parallelism", 1))
                .shuffleGrouping("patch-gen", PATCH_FRAME_STREAM)
        ...
        StormSubmitter.submitTopology("resa-vd-JB-delta", resaConfig, builder.createTopology());
