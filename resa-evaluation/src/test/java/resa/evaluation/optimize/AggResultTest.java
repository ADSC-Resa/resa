...
public class AggResultTest {
    ...
    public void testGetCombinedResult() throws Exception {
        ...
        srcAggResult.getRecvQueueResult().add(1, 1, 1, 1, 1);
        srcAggResult.getSendQueueResult().add(2, 2, 2, 2, 2);
        ...
        AggResult.getHorizontalCombinedResult(aggResult, aggResultList);
